function RightCourtWithColliAvoid(r,centerpnt,side,xPos,angle,velocity)
%
q1C= zeros(1,7);
q2C = [-2 deg2rad([0 0 0 0 0 -30])];
qHit = [-1.25 deg2rad([0 0 0 0 0 0])];
%
...
for i = 1:steps-1
    ...
    qMatrix(i+1,5) = deg2rad(-80)-deg2rad(90)/68*i;
    qMatrix(i+1,6) = 0;
    qMatrix(i+1,7) = pi/2;
end
