...
v = load('v.mat');
BrickVertexCount = 2588;
[BrickMesh_h] = PlotBird(xPos);
%%
%
% q1C= zeros(1,7);
...
num = 65;
for i = 1:num
predict = plot3(x(1,i),y(1,i),z(1,i),'o','MarkerSize',3,'Color','r');
pause(0.01);
delete(predict);
end
...
for i = 1:steps-1
    ...
    %qMatrix(i,1:6) =  qMatrix(i,1:6) + deltaT*qdot(1:6,1)';
...
for i=1:num  
    ...
    if EButton == 1
        ...
        BrickMesh_h.Vertices = UpdatedPoints(:,1:3);
        disp("Emergency Button: Triggered!")
        break
    end
...
for i=num:-1:1    
    ...
    BrickMesh_h.Vertices = UpdatedPoints(:,1:3);
        ...
        if EButton == 1
            ...
            disp("Emergency Button: Triggerd!")
            break
        end
